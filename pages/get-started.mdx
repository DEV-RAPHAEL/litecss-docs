...
LiteCss is a Medium yet Powerful CSS Framework and Frontend Toolki. Build anything—from prototype to production—in minutes.
...
## ⚡ Manual Download
Download the  [CSS](https://codepen.io/dev-raphael/pen/BaxYXxy) file
